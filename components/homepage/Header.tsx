    ...
    <>
      <header className="bg-green-500 shadow-md p-4 mb-8 rounded-lg">
        <nav className="flex justify-between items-center">
          <div className="logo">
            <h1 className="text-white text-lg sm:text-xl">I'm Hungry AI</h1>
          </div>
        </nav>
      </header>
      <section className="hero flex flex-wrap items-center justify-between bg-lime-50 p-6 md:p-10 rounded-lg">
        <div className="hero-content flex-1 max-w-full md:max-w-md">
          ...
          <p className="text-black mt-4 text-sm sm:text-base md:text-lg">
            At I'm Hungry AI, we believe that cooking should be a delightful adventure, not a daunting task. Our state-of-the-art AI recipe generator is here to transform your kitchen experience, bringing creativity, ease, and joy to every meal you prepare.
          </p>
